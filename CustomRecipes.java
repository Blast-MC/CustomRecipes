package me.blast.craftingrecipes;
...
public class CustomRecipes extends JavaPlugin{
    ...
    public ShapelessRecipe createSingleItemShapelessRecipe(Material inputItem, int requiredAmount, Material outputItem, int outputAmount){
        ShapelessRecipe recipe = new ShapelessRecipe(new ItemStack(outputItem, outputAmount));
    ...
    public ShapedRecipe createColorChangingRecipe(RecipeChoice.MaterialChoice inputItem, Material dye, Material outputItem){
        ShapedRecipe recipe = new ShapedRecipe(new ItemStack(outputItem, 8));
    ...
    public void concretePowderDying(){
        addRecipe(createColorChangingRecipe(concretePowder, Material.BONE_MEAL, Material.WHITE_CONCRETE_POWDER));
        addRecipe(createColorChangingRecipe(concretePowder, Material.INK_SAC, Material.BLACK_CONCRETE_POWDER));
        ...
        addRecipe(createColorChangingRecipe(concretePowder, Material.CACTUS_GREEN, Material.GREEN_CONCRETE_POWDER));
        ...
        addRecipe(createColorChangingRecipe(concretePowder, Material.ROSE_RED, Material.RED_CONCRETE_POWDER));
        addRecipe(createColorChangingRecipe(concretePowder, Material.DANDELION_YELLOW, Material.YELLOW_CONCRETE_POWDER));
    }

    public void stainedGlassDying(){
        addRecipe(createColorChangingRecipe(stainedGlass, Material.BONE_MEAL, Material.WHITE_STAINED_GLASS));
        addRecipe(createColorChangingRecipe(stainedGlass, Material.INK_SAC, Material.BLACK_STAINED_GLASS));
        ...
        addRecipe(createColorChangingRecipe(stainedGlass, Material.CACTUS_GREEN, Material.GREEN_STAINED_GLASS));
        ...
        addRecipe(createColorChangingRecipe(stainedGlass, Material.ROSE_RED, Material.RED_STAINED_GLASS));
        addRecipe(createColorChangingRecipe(stainedGlass, Material.DANDELION_YELLOW, Material.YELLOW_STAINED_GLASS));
    }

    public void stainedGlassPaneDying(){
        addRecipe(createColorChangingRecipe(stainedGlassPane, Material.BONE_MEAL, Material.WHITE_STAINED_GLASS_PANE));
        addRecipe(createColorChangingRecipe(stainedGlassPane, Material.INK_SAC, Material.BLACK_STAINED_GLASS_PANE));
        ...
        addRecipe(createColorChangingRecipe(stainedGlassPane, Material.CACTUS_GREEN, Material.GREEN_STAINED_GLASS_PANE));
        ...
        addRecipe(createColorChangingRecipe(stainedGlassPane, Material.ROSE_RED, Material.RED_STAINED_GLASS_PANE));
        addRecipe(createColorChangingRecipe(stainedGlassPane, Material.DANDELION_YELLOW, Material.YELLOW_STAINED_GLASS_PANE));
    }

    public void terracottaDying(){
        addRecipe(createColorChangingRecipe(terracotta, Material.BONE_MEAL, Material.WHITE_TERRACOTTA));
        addRecipe(createColorChangingRecipe(terracotta, Material.INK_SAC, Material.BLACK_TERRACOTTA));
        ...
        addRecipe(createColorChangingRecipe(terracotta, Material.CACTUS_GREEN, Material.GREEN_TERRACOTTA));
        ...
        addRecipe(createColorChangingRecipe(terracotta, Material.ROSE_RED, Material.RED_TERRACOTTA));
        addRecipe(createColorChangingRecipe(terracotta, Material.DANDELION_YELLOW, Material.YELLOW_TERRACOTTA));
    }

    public void setWoolUndyingRecipe(){
        ShapedRecipe woolUndyingRecipe = new ShapedRecipe(new ItemStack(Material.WHITE_WOOL, 8));
